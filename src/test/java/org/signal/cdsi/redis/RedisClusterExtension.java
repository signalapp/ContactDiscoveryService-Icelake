...
public class RedisClusterExtension implements BeforeAllCallback, BeforeEachCallback, AfterEachCallback, AfterAllCallback {
  ...
  public void beforeEach(final ExtensionContext context) {
    ...
    redisClusterClient = RedisClusterClient.create(clientResources, redisUris);
  ...
  private SocketAddressResolver getSocketAddressResolver() {
